...
MODEL_DIRECTORY = "/home/pvossler/cm_idea/combined_test/"
combined_train_msk_path = MODEL_DIRECTORY+"combined_train_msk.csv"
...
# Load data
combined_data = pd.read_csv("/home/pvossler/ps_job/combined_clean.csv")

factor_list = pd.read_csv("/home/pvossler/ps_job/combined_factor_list.csv").values.tolist()
chunk_list = pd.read_csv("/home/pvossler/ps_job/combined_chunk_list.csv").values.tolist()
cat_var_idx = pd.read_csv("/home/pvossler/ps_job/combined_cat_var_idx.csv").values.tolist()
